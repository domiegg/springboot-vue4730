	...
	<div class="main-containers">
		...
		<div class="top-container" :style='{"boxShadow":"0 0px 0px rgba(64, 158, 255, .3)","padding":"0px calc((100% - 1200px)/2)","borderColor":"#C20C0C","alignItems":"center","color":"rgb(204, 204, 204)","textAlign":"right","display":"flex","justifyContent":"flex-end","overflow":"hidden","top":"0","borderRadius":"0","left":"0","background":"#3a3a3a","borderWidth":"0px","width":"100%","fontSize":"14px","lineHeight":"36px","position":"fixed","borderStyle":"solid","height":"36px","zIndex":"1002"}'>
			...
			<div :style='{"padding":"0","margin":"0","left":"calc((100% - 1200px)/2)","background":"none","display":"inline-block","width":"auto","position":"absolute","float":"left","height":"100%"}'>
			  <span @click="goMenu('/index/home')" :style='{"padding":"0px","color":"inherit","alignItems":"center","display":"flex","width":"100%","lineHeight":"1.5","fontSize":"16px","float":"left","fontWeight":"500","height":"100%"}'>基于软件研发过程中的缺陷管理系统的设计与实现</span>
			</div>
			...
			<el-scrollbar wrap-class="scrollbar-wrapper-horizontal">
				<el-menu class="el-menu-horizontal-demo" :style='{"border":"0","padding":"15px calc((100% - 1200px)/2)","listStyle":"none","margin":"0","alignItems":"flex-start","background":"none","display":"flex"}' :default-active="activeMenu" :unique-opened="true" mode="horizontal" :router="true" @select="handleSelect">
					...
					<el-menu-item class="home" index="/index/home" @click.native="goMenu('/index/home')">
						...
						<span :style='{"padding":"0 0px","lineHeight":"auto","fontSize":"18px","color":"inherit","fontWeight":"600","height":"auto"}'>首页</span>
					</el-menu-item>
					<el-menu-item class="item" v-for="(menu, index) in menuList" :index="menu.url" :key="index" @click.native="goMenu(menu.url)">
						...
						<span :style='{"padding":"0 0px","lineHeight":"auto","fontSize":"18px","color":"inherit","fontWeight":"600","height":"auto"}'>{{menu.name}}</span>
					</el-menu-item>
					<el-menu-item class="user" index="/index/center" v-if="Token && notAdmin" @click.native="goMenu('/index/center')">
						<span :style='{"padding":"0 10px","margin":"0","color":"inherit","display":"none","width":"14px","lineHeight":"auto","fontSize":"14px","height":"auto"}' class="icon iconfont icon-shouye-zhihui"></span>
						<span :style='{"padding":"0 10px","lineHeight":"auto","fontSize":"18px","color":"inherit","height":"auto"}'>个人信息</span>
					</el-menu-item>
				</el-menu>
			</el-scrollbar>
			</div>
...
export default {
    data() {
		return {
            activeIndex: '0',
			roleMenus: [{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-brand","buttons":["新增","查看","修改","删除"],"menu":"开发人员","menuJump":"列表","tableName":"kaifarenyuan"}],"menu":"开发人员管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-rank","buttons":["新增","查看","修改","删除"],"menu":"测试人员","menuJump":"列表","tableName":"ceshirenyuan"}],"menu":"测试人员管理"},{"child":[{"allButtons":["新增","查看","修改","删除","状态","严重程度数","测试负责数","开发负责数","首页总数","首页统计"],"appFrontIcon":"cuIcon-camera","buttons":["新增","查看","修改","删除","首页总数","首页统计"],"menu":"缺陷信息","menuJump":"列表","tableName":"quexianxinxi"}],"menu":"缺陷信息管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-copy","buttons":["查看","修改","删除"],"menu":"论坛管理","tableName":"forum"}],"menu":"论坛管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-keyboard","buttons":["查看","修改","删除"],"menu":"轮播图管理","tableName":"config"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"公告资讯","tableName":"news"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"公告资讯分类","tableName":"newstype"},{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-rank","buttons":["查看","修改"],"menu":"关于我们","tableName":"aboutus"}],"menu":"系统管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","状态","严重程度数","测试负责数","开发负责数","首页总数","首页统计"],"appFrontIcon":"cuIcon-list","buttons":["查看","修改"],"menu":"缺陷信息列表","menuJump":"列表","tableName":"quexianxinxi"}],"menu":"缺陷信息模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"管理员","tableName":"users"},{"backMenu":[],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","状态","严重程度数","测试负责数","开发负责数","首页总数","首页统计"],"appFrontIcon":"cuIcon-list","buttons":["查看","修改"],"menu":"缺陷信息列表","menuJump":"列表","tableName":"quexianxinxi"}],"menu":"缺陷信息模块"}],"hasBackLogin":"否","hasBackRegister":"否","hasFrontLogin":"是","hasFrontRegister":"是","roleName":"开发人员","tableName":"kaifarenyuan"},{"backMenu":[],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","状态","严重程度数","测试负责数","开发负责数","首页总数","首页统计"],"appFrontIcon":"cuIcon-list","buttons":["查看","修改"],"menu":"缺陷信息列表","menuJump":"列表","tableName":"quexianxinxi"}],"menu":"缺陷信息模块"}],"hasBackLogin":"否","hasBackRegister":"否","hasFrontLogin":"是","hasFrontRegister":"是","roleName":"测试人员","tableName":"ceshirenyuan"}],
			baseUrl: '',
			carouselList: [],
			menuList: [],
			form: {
